...
- **IMAGES list** — `["adversarial-taboo", "charades", "odes-for-cave-men", "yip-yap", "two-rooms-and-a-boom", "decrypto", "games-landing"]` in `deploy.py`, must match `container_name` values in `docker-compose.yml`
