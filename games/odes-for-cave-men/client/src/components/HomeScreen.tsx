  ...
  return (
    <div className="h-full flex flex-col items-center justify-center p-6 gap-10 animate-fade-in">
      <div className="fixed inset-0 pointer-events-none">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[400px] bg-amber-600/10 rounded-full blur-[120px]" />
      </div>

      <div className="text-center relative z-10">
        <h1
          className="font-display text-6xl tracking-wider text-white mb-3"
          style={{ textShadow: '0 0 40px rgba(217, 119, 6, 0.4)' }}
        >
          ODES FOR CAVE MEN
        </h1>
        <p className="text-gray-500 text-sm tracking-widest uppercase">Use small words. Describe big things.</p>
      </div>
