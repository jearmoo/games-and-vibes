        ...
        <div className="space-y-4 text-sm leading-relaxed">
          ...
          <div>
            ...
            <div className="space-y-2 text-gray-400">
              ...
              <p>
                <span className="text-white font-medium">Clue-Giver</span> — Describes words to teammates without using
                any taboo words.
              </p>
              <p>
                <span className="text-white font-medium">Guesser</span> — Listens to clues and guesses the words.
              </p>
              <p>
                <span className="text-white font-medium">Watcher</span> — Observes the other team's cluing turn.
              </p>
            </div>
          </div>
